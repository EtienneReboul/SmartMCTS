...
Smart MCTS started out as a project generated from [Cookiecutter PyPackage](https://github.com/audreyfeldroy/cookiecutter-pypackage) containing:

- Initial scaffold for Smart MCTS.
- `src/smart_mcts/` package with CLI (Typer + Rich), py.typed marker
...
[@EtienneReboul](https://github.com/EtienneReboul) (Etienne Reboul) created Smart MCTS.
