...
If you find a security vulnerability in Smart MCTS, please report it through [GitHub's private vulnerability reporting](https://github.com/EtienneReboul/smart-mcts/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact reeetienne@gmail.com for details.
